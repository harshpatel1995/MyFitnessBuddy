   ...
   public void previewPredefinedWorkoutButton(View view)
    {
        ...
        if(selected.size()<1){
            ...
            if (!workoutStr.equals("")) {
                ...
                try {
                    ...
                    Cursor c_v4 = exerciseDB.rawQuery("SELECT exercises FROM predefinedWorkouts", null);
                    //get items from "name" column of table
        ...
        //adapter to get list into ListView
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.list_content, predefinedWorkoutListArr);
        workoutLV.setAdapter(adapter);
